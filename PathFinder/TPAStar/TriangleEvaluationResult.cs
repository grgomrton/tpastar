...
{
    /// <summary>
    /// Contains the result of an evaluation of a triangle during exploring the triangle graph.
    /// </summary>
    public class TriangleEvaluationResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TriangleEvaluationResult"/> class
        /// which contains details about the result of a triangle evaluation during exploration.
        /// </summary>
        ...
        /// that have been stepped over during building the path.
        /// </summary>
        ...
        /// <summary>
        /// The length of the possibly longest path from the start to the current edge along the set of triangles
        /// that have been stepped over during building the path.
        /// </summary>
