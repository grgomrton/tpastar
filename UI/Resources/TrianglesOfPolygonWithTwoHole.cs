...
namespace TriangulatedPolygonAStar.UI.Resources
{
    public static partial class TriangleMaps
    {
        private static IEnumerable<Triangle> GetTrianglesOfPolygonWithTwoHoles()
        {
            ...
            triangleSet.Add(t2);
            Triangle t3 = new Triangle(cl1, cr1, cl5);
            triangleSet.Add(t3);
            Triangle t4 = new Triangle(cr1, cl5, cr2);
            triangleSet.Add(t4);
            ...
            triangleSet.Add(t11);
            Triangle t12 = new Triangle(cl5, cr2, cl2);
            triangleSet.Add(t12);
            Triangle t13 = new Triangle(cl2, cl5, cp1);
            triangleSet.Add(t13);
            Triangle t14 = new Triangle(cl4, cl2, cp1);
            triangleSet.Add(t14);
