...
namespace TriangulatedPolygonAStar.UI
{
    ...
    /// </summary>
    public class StartMarker : ILocationMarker
    {
        private static readonly float Radius;
        private static readonly Brush FillBrush;
                
        /// <summary>
        /// Initializes a new instance of the <see cref="StartMarker"/> class which
        /// draws a mark at the start location on the canvas.
        /// </summary>
        /// <param name="position">The position of this point</param>
        public StartMarker(IVector position)
        {
