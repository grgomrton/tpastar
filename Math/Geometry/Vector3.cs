...
namespace CommonTools.Geometry
{
    ...
    /// The whole struct is written by Richard Potter, 
    /// only some additional function were added under the #Custom code section.
    /// </summary>
        ...
        : IComparable, IComparable<Vector3>, IEquatable<Vector3>, IFormattable
    {
        ...
        /// <param name="degree">The angle to rotate the Vector3 around in radians</param>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Vector3"/> struct that represents a 2D vector.
        /// </summary>
        ...
        public float Xf
        {
            get { return Convert.ToSingle(X); }
        }

        /// <summary>
        /// Gets the y coordinate converted to float. For drawing purposes only!
        /// </summary>
        public float Yf
        {
            get { return Convert.ToSingle(Y); }
        }

        /// <summary>
        /// Converts the projection of this instance on the (x,y) plane to PointF structure.
        /// </summary>
        /// <returns></returns>
